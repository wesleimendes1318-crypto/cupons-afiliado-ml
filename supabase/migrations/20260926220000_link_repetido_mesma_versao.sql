-- Link repetido so volta na hora se a analise foi feita pela versao ATUAL da
-- extensao (26/09: a Tomate W12 voltou com o frete errado da 1.113.0 depois
-- da correcao na 1.114.0).
...
BEGIN
  ...
  /* RESPOSTA NA HORA para link repetido (menos de 1 hora, analise completa,
     com link) feito pela MESMA versao da extensao que esta rodando agora. */
